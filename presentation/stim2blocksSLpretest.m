function [blockIdx, stimTypes, stimTypeIdx, stimArray, trialIdx] = stim2blocksSLpretest(stimArrayFile, blockNo)
%% Helper function sorting stimuli to blocks and trials
%
% USAGE: [blockIdx, stimTypes, stimTypeIdx, stimArray] = stim2blocksSupervisedLearning(stimArrayFile, blockNo)
%
...
%               coherence level and figure presence/absence. 
%               Its size is "no. of unique types" X 4, with the fourth 
...
stepSizeValues = cell2mat(stimArray(:, 7));
...
% user message
disp([newline, 'Sorted stimuli into blocks, with equal number of trials per type per block']);

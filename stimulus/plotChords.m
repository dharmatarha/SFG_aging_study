function fig = plotChords(folder, wavN)
%% Plot background + figure chords for SFG stimulus
%
% USAGE: fig = plotChords(folder, wavN)
%
...
% wavN          - Numeric value, stimulus number (wav files are numbered in
%               folders generated by createSFGstimuli.m)
%

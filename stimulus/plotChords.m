...
%
% Inputs:
% folder        - Directory for the wav files, containing also the
%               parameter files
...
if ~ismembertol(wavN, 1:10000)
    error('Input arg "wavN" should be between 1:10000, please check again or rewrite the function!');
end
...
figPresent = T(wavN, :).figure{1};  % figure coherent or random ('yes' or 'no')

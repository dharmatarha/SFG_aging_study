function wavDir = createSFGstimuli(NStimuli, stimopt, OEMfiltering)
%% Creates a sequence of Nstimuli stochastic figure-ground (SFG) stimulus.
% 
% USAGE: wavDir = createSFGstimuli(NStimuli, stimopt, OEMfiltering=false)
%
...
if ~ismembertol(nargin, 1:3)
    error('Function createSFGstimuli requires input args "NStimuli" and "stimopt" while input arg "OEMfiltering" is optional!');
end
if nargin == 2
    OEMfiltering = false;
end

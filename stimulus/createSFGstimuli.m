function wavDir = createSFGstimuli(NStimuli, stimopt, loudnessEq)
%% Creates a sequence of Nstimuli stochastic figure-ground (SFG) stimulus.
% 
% USAGE: wavDir = createSFGstimuli(NStimuli, stimopt, loudnessEq=false)
%
...
if ~ismembertol(nargin, 2:3)
    error('Function createSFGstimuli requires input args "NStimuli" and "stimopt" while input arg "loudnessEq" is optional!');
end
if nargin == 2
    loudnessEq = false;
end

...
%
% USAGE: SFGthresholdCoherence(subNum, stimopt=SFGparamsThreshold, trialMax=90, loudnessEq=true)
%
...
%
% The function returns the Quest object ("q") and also saves out results to 
% the folder of the subject. The subject's folder is created in the current 
...
if ~ismember(nargin, 1:4) 
    error('Function SFGthresholdCoherence needs mandatory input arg "subNum" while args "stimopt", "trialMax" and "loudnessEq" are optional!');
end
...
% settings for quest 
qopt = struct;
qopt.tGuess = 1.73;  % prior threshold guess, 1.73 equals an SNR of ~5.6 (=coherence level of 17, at stimopt.toneComp=20), we start from very high
